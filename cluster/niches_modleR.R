...
tmin_stack_2010 <- list.files("~/save/data/WorldClim/2010",
                              pattern = "tmin",
                              full.names = TRUE) %>% stack()

tmax_stack_2010 <- list.files("~/save/data/WorldClim/2010",
                              pattern = "tmax",
                              full.names = TRUE) %>% stack()

prec_stack_2010 <- list.files("~/save/data/WorldClim/2010",
                              pattern = "prec",
                              full.names = TRUE) %>% stack()

climatic_stack_2010 <- stack(tmin_stack_2010, tmax_stack_2010, prec_stack_2010)
