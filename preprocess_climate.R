...
writeRaster(tmin_mean_1970,
            filename=paste0(avgDir, "/1970/avg_tmin_1970.tif"),
            format="GTiff",
            overwrite=TRUE,
            options=c("COMPRESS=DEFLATE",
                      "PREDICTOR=2",
...
writeRaster(tmax_mean_1970,
            filename=paste0(avgDir, "/1970/avg_tmax_1970.tif"),
            format="GTiff",
            overwrite=TRUE,
            options=c("COMPRESS=DEFLATE",
                      "PREDICTOR=2",
...
writeRaster(tmean_1970,
            filename=paste0(avgDir, "/1970/avg_tmean_1970.tif"),
            format="GTiff",
            overwrite=TRUE,
            options=c("COMPRESS=DEFLATE",
                      "PREDICTOR=2",
...
writeRaster(prec_mean_1970,
            filename=paste0(avgDir, "/1970/avg_prec_1970.tif"),
            format="GTiff",
            overwrite=TRUE,
            options=c("COMPRESS=DEFLATE",
                      "PREDICTOR=2",
